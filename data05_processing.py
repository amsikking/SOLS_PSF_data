...
def view_in_napari(preview, voxel_aspect_ratio, traditional):
    ...
    with napari.gui_qt():
        ...
        viewer_2.add_image(traditional[:,:,0,:,:], name='traditional')
...
imwrite('data05_preview.tif', preview)
...
##imwrite('data05_native.tif', native)
...
##imwrite('data05_traditional.tif', traditional)
traditional = traditional[:, 376:398, :, 41:865, :] # manually cropped
print('-> saving: data05_traditional.tif')
imwrite('data05_traditional.tif', traditional)
